...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>admin</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AdminExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.admin"));
				Admin root = AdminFactory.eINSTANCE.createAdmin();
