...
import java.net.URI;
import static com.verticon.tracker.irouter.gps.ui.internal.bundle.Activator.*;
 ...
 *
 */
class URIWizardProxy implements IURIWizard {

	/**
	 * slf4j Logger
	 */
	private final Logger logger = LoggerFactory.getLogger(URIWizardProxy.class);
	...
	private IURIWizard delegate = null;
	
	
	protected URIWizardProxy(IConfigurationElement configElm) {
		super();
...
//		getAttribute(configElm, ATT_CLASS, null);//REMOVE
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		if(delegate==null){
			try {
				delegate = (IURIWizard)configElement.createExecutableExtension(ATT_CLASS);
//				System.out.println(this+" Created "+delegate);
				logger.debug(bundleMarker, "{} created name={} in={}",
						new Object[]{this,name,configElement.getDeclaringExtension().getContributor().getName()});
				...
				Logger logger = LoggerFactory
						.getLogger(URIWizardProxy.class);
			      logger.error(msg, e);
			      return;
			}
		}
