...
public class FairEditor
	 ...
	 * @generated NOT
	 */
	protected final Logger logger = LoggerFactory.getLogger(FairEditor.class);
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(FairEditor.this);
			...
			propertySheetPage =
				new ExtendedPropertySheetPage(editingDomain) {
					...
					public void setSelectionToViewer(List<?> selection) {
						FairEditor.this.setSelectionToViewer(selection);
						FairEditor.this.setFocus();
					}
	...
	private static String getString(String key, Object s1) {
		return FairEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
