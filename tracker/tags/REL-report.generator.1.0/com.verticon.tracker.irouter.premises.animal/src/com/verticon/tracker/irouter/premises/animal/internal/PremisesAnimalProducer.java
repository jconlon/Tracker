...
import static com.verticon.tracker.irouter.premises.animal.internal.AnimalTransactionConsumer.bundleMarker;
...
public class PremisesAnimalProducer implements Producer {

	/**
	 * slf4j Logger
	 */
	private final Logger logger = LoggerFactory
			.getLogger(PremisesAnimalProducer.class);
