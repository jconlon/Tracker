...
import com.verticon.tracker.fair.util.FairResourceFactoryImpl;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>fair</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FairExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.fair"));
				Fair root = FairFactory.eINSTANCE.createFair();
