...
public class DoubleSensor extends SimulatedParameter {
	/**
	 * slf4j Logger
	 */
	private final Logger logger = LoggerFactory.getLogger(DoubleSensor.class);
	...
	protected double smallIncrement;
	protected double largeIncrement;
	...
	public DoubleSensor(String name, String label, int scaleFactor,
			double minValue, double maxValue, double defaultValue, double smallIncrement,
	...
	public DoubleSensor(String name, String label, double minValue, double maxValue,
			double defaultValue, double smallIncrement, double largeIncrement,
	...
	protected void nextStep() {
		...
		double increments = range / smallIncrement;
		double lengths = runningStep / increments;
		double remainder = runningStep % increments;
		if (lengths % 2 == 0) {
