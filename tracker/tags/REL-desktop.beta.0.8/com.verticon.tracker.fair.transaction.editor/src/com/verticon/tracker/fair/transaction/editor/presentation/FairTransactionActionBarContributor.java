 ...
 * TODO subclass the FairActionBarContributor
 * <!-- end-user-doc -->
 * @generated
 */
public class FairTransactionActionBarContributor
	 ...
	 * @generated NOT
	 */
	private ICustomActionBarContributor customActionBarContributor = 
		new FairTransactionCustomActionBarContributor();
	...
	protected IAction showPropertiesViewAction =
		new Action(FairTransactionEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(FairTransactionEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public FairTransactionActionBarContributor() {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(FairTransactionEditorPlugin.INSTANCE.getString("_UI_FairEditor_menu"), "com.verticon.tracker.fairMenuID");
		...
		//
		createChildMenuManager = new MenuManager(FairTransactionEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(FairTransactionEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(FairTransactionEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(FairTransactionEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
