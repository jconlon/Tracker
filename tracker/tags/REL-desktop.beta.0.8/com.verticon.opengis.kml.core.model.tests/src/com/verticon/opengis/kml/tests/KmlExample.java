...
import com.verticon.opengis.kml.Alias;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>kml</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class KmlExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ogckml"));
				DocumentRoot documentRoot = KmlFactory.eINSTANCE.createDocumentRoot();
				Alias root = KmlFactory.eINSTANCE.createAlias();
				documentRoot.setAlias(root);
