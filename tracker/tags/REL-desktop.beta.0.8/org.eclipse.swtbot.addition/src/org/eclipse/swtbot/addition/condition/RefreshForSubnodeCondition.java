...
*******************************************************************************/
package org.eclipse.swtbot.addition.condition;
...
/**
 * wait condition, which does a refresh on a tree node and waits for a specific sub node to appear after refresh
 * this conditions assumes that the parentTreeItem has a context menu which does a refresh
 * this is useful in situations where sub nodes only become visible after refresh, e.q. package explorer eclipse ide
...
public class RefreshForSubnodeCondition implements ICondition
{
	 ...
	 * @param subnodeText - the text for the expected child tree item
	 * @param refreshContextMenuText - the text for the refresh context menu item of the parent item
	 */
