The docBook external resources were added to the Tracker repository so this documuntation 
projects can be easily created from the repository.  This does almost double the size of 
