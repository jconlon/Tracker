...
public class LotItemProvider
	 ...
	 * @generated
	 */
	public LotItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Lot"));
	}
	...
	public String getText(Object object) {
		String label = ((Lot)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Lot_type") :
			getString("_UI_Lot_type") + " " + label;
	}
