...
public class TrackerActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(TrackerReportEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(TrackerReportEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(TrackerReportEditorPlugin.INSTANCE.getString("_UI_TrackerEditor_menu"), "com.verticon.trackerMenuID");
		...
		//
		createChildMenuManager = new MenuManager(TrackerReportEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(TrackerReportEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
