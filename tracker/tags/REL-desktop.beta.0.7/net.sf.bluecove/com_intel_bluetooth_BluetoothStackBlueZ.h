...
#define com_intel_bluetooth_BluetoothStackBlueZ_NATIVE_LIBRARY_VERSION 2000300L
 ...
 * Signature: (Lcom/intel/bluetooth/DeviceInquiryThread;IIIIILjavax/bluetooth/DiscoveryListener;)I
 */
 ...
 * Signature: (JZZZZZIII)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_bluetooth_BluetoothStackBlueZ_l2ServerOpenImpl
  (JNIEnv *, jobject, jlong, jboolean, jboolean, jboolean, jboolean, jboolean, jint, jint, jint);
