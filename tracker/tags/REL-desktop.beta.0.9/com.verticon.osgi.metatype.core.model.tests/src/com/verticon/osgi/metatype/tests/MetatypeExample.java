...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>metatype</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MetatypeExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.metatype"));
				DocumentRoot documentRoot = MetatypeFactory.eINSTANCE.createDocumentRoot();
				MetaData root = MetatypeFactory.eINSTANCE.createMetaData();
				documentRoot.setMetaData(root);
