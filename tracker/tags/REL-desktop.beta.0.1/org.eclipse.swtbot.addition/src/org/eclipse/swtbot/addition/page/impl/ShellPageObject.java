...
*******************************************************************************/
package org.eclipse.swtbot.addition.page.impl;

import org.eclipse.swtbot.addition.condition.ShellCondition;
import org.eclipse.swtbot.addition.page.IShellPageObject;
...
public abstract class ShellPageObject<T extends SWTBot> extends AbstractPageObject<T> implements IShellPageObject
{
	...
	/**
	 * constructor
	 * @param title - the test for which the page object has been created
	 * @param bot - the bot
	 */
