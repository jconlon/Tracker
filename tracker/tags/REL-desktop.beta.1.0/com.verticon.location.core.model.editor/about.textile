...
com.verticon.location.core.model.editor Version 0.1.0
...
Location Editor feature provides a data model and an editor for creating and editing documents
that contain geographic location (Geolocation) information. 
