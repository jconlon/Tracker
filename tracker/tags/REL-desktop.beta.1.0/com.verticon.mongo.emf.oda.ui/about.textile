h1=. Mongo EMF ODA User Interface

com.verticon.mongo.emf.oda.ui Version 0.1.0
...
Mongo EMF ODA User Interfaces provides the graphical user interfaces enabling Eclipse Business Intelligence Reporting Tool (BIRT) access to EMF documents stored in MongoDB.
