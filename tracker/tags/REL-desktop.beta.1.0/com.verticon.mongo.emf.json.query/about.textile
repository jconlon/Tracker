h1=. Mongo EMF JSON Query

com.verticon.mongo.emf.json.query Version 0.1.0
...
Mongo EMF JSON Query adds a query language to the MongoEMF framework that is similar to the query language used in the Mongo command line shell. 
