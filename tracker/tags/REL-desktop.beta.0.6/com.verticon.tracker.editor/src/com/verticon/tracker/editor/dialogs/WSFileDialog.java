 ...
 * Modified by 
 * <ul>
 * <li>Instantiating a WorkbenchLabelProvider directly instead of obtaining it
 * via an internal API.
 * <li>Adding a setter for adding an external ViewerFilter.
 * </ul>
 * 
 * 
 * @author jconlon
...
public class WSFileDialog extends Dialog {
    ...
    private ViewerFilter patternFilter = new FilePatternFilter();
	...
	public void setPatternFilter(ViewerFilter patternFilter) {
