 ...
 * 
 ***********************************************copyright 2006 - 2010**********/
package org.ekkescorner.logging.starter.runtime.internal;
        ...
        context.addBundleListener(new BundleListener(){
			...
			public void bundleChanged(BundleEvent event) {
		    	...
		    	logger.info(bundleMarker,
		    			"BundleEvent: B: {} new state: {}",	//$NON-NLS-1$
			...
			public void frameworkEvent(FrameworkEvent event) {
				...
				case FrameworkEvent.ERROR:
					logger.error(bundleMarker,
			    			"FrameworkEvent: ERROR in bundle {}",	//$NON-NLS-1$
			    			event.getBundle().getSymbolicName(),
			    			event.getThrowable()); 
					break;
				case FrameworkEvent.WARNING:
					logger.warn(bundleMarker,
			    			"FrameworkEvent: WARNING in bundle {}",	//$NON-NLS-1$
			    			event.getBundle().getSymbolicName()); 
					break;
				case FrameworkEvent.STARTED:
					logger.info(bundleMarker,
			    			"FrameworkEvent bundle {} started",	//$NON-NLS-1$
			    			event.getBundle().getSymbolicName()); 
					break;
				default:
					// not logged:
