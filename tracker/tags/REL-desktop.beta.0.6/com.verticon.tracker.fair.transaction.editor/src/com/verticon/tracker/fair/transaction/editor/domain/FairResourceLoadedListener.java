 ...
 */
public class FairResourceLoadedListener extends DemultiplexingListener {
	private static FairResourceLoadedListener instance;
	 ...
	 */
	public FairResourceLoadedListener() {
	 ...
	 */
	public static FairResourceLoadedListener getDefault() {
		return instance;
	}
...
//							System.out.println("Opening "+file+ " with "+this);
							if (page != null) {
								...
								page.openEditor(
										...
										"com.verticon.tracker.fair.transaction.editor.presentation.FairEditorID", //$NON-NLS-1$
										false);
							...
							FairTransactionEditorPlugin.getPlugin().log(e.getStatus());
						}
					}});
			}
