...
public class Subscriber implements MqttCallback, ISubscriber {
	...
	/* (non-Javadoc)
	 * @see com.verticon.tracker.store.mqtt.test.system.ISubscriber#messages()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.verticon.tracker.store.mqtt.test.system.ISubscriber#messageArrived(java.lang.String, org.eclipse.paho.client.mqttv3.MqttMessage)
	 */
	@Override
