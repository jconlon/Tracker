...
/**
 * This is the item provider adapter for a {@link com.verticon.tracker.Station} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Station_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Station_id_feature", "_UI_Station_type"),
				 TrackerPackage.Literals.STATION__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TrackerPackage.Literals.STATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Station_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Station_description_feature", "_UI_Station_type"),
				 TrackerPackage.Literals.STATION__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLocationNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Station_locationName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Station_locationName_feature", "_UI_Station_type"),
				 TrackerPackage.Literals.STATION__LOCATION_NAME,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCoordinatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Station_coordinates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Station_coordinates_feature", "_UI_Station_type"),
				 TrackerPackage.Literals.STATION__COORDINATES,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TrackerPackage.Literals.STATION__EVENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.STATION__EVENTS,
				 TrackerFactory.eINSTANCE.createWind()));

		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.STATION__EVENTS,
				 TrackerFactory.eINSTANCE.createStationLocation()));

		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.STATION__EVENTS,
				 TrackerFactory.eINSTANCE.createAir()));

		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.STATION__EVENTS,
				 TrackerFactory.eINSTANCE.createLight()));

		newChildDescriptors.add
			(createChildParameter
				(TrackerPackage.Literals.STATION__EVENTS,
				 TrackerFactory.eINSTANCE.createOrientation()));
	}
	...
	protected CommandParameter createChildParameter(Object feature, Object child) {
		if (child instanceof SensorEvent) {
			((SensorEvent) child).setDateTime(new Date());
		}
