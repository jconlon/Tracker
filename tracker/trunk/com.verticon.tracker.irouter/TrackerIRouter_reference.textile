...
#log4j.logger.com.verticon.tracker.mettler=DEBUG


h3. Configuration Admin

On the webconsole go to the Configuration tab and create Tracker Factory Configuations.  Create two instances for each Factory.
