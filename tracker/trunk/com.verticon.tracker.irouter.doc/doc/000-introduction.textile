...
** Interface with external device for data acquisition from physical sensors
** Data transformation and computation between services
** Interface with external devices for the output of measurement and state data to physical actuators
...
"The OSGi Alliance":http://www.osgi.org/About/HomePage offers a modular framework for software components and specifications that meet most of the technical requirements outlined above.   

The following sections overview the pertinent technologies specified by the OSGi and their relationship to the requirements.[2]

h4. OSGi Measurement and State

The OSGi Measurement and State "specification":http://www.osgi.org/Specifications/HomePage offers a comprehensive[3] way to model physical measurement and state data.  
