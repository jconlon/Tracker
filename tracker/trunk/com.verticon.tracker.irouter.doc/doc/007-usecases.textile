...
__iRouter monitor view of an integrated Premises Desktop__

The above is the iRouter monitor view of a configuration that integrates TruTest scale heads and RFID readers with a Tracker Desktop transaction processing environment.  
...
h3. Annotated Monitor View

!images/dependencies.png!
__iRouter annotated monitor view of an integrated multi sensor data logger__

The above is the annotated view of a configuration of an integrated sensor data logger. 

h3. Configuration

Instead of using multiple generic components for business logic, which is possible even with complex business logic scenarios such as this, this configuration instead uses a single custom business logic component for controlling and transforming the complex information network flows.  
