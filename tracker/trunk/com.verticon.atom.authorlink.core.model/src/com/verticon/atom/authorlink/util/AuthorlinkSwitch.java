 ...
 * @generated
 */
public class AuthorlinkSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AuthorlinkPackage.ATOM_ROOT: {
				AtomRoot atomRoot = (AtomRoot)theEObject;
				T result = caseAtomRoot(atomRoot);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Atom Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Atom Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAtomRoot(AtomRoot object) {
		return null;
	}
