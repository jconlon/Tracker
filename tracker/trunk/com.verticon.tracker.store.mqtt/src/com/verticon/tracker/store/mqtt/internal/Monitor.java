...
import static com.verticon.tracker.store.TrackerStoreUtils.getAnimalEClass;
import static com.verticon.tracker.store.TrackerStoreUtils.getConfigurationInteger;
import static com.verticon.tracker.store.mqtt.internal.StatusAndConfigVariables.instance;
...
public class Monitor implements Monitorable {
	...
	public StatusVariable getStatusVariable(String id)
		...
		case DEFAULT_ANIMAL:
			Integer key = getConfigurationInteger(config.get(var.configID));
			String name = getAnimalEClass(key).getName();
