...
com.verticon.tracker.irouter.mqtt Version 1.0.0
...
iRouter MQTT feature contains Eclipse Paho MQTT Client drivers, iRouter base utilities for iRouter MQTT services and an iRouter component for sending messages between MQTT and the iRouter infrastructure.


h2. Powered by Eclipse Technology

Verticon's iRouter MQTT offering is powered by Eclipse technology and includes Eclipse plug-ins that can be installed and used with other Eclipse-based offerings.
