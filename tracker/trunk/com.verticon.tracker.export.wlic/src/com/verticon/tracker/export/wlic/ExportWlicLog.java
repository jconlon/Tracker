...
/**
 * The logger of convenience for the ExportXls plug-in.
 */
public class ExportWlicLog {
   /**
   ...
   public static IStatus createStatus(int severity, int code,
      ...
      return new Status(severity, ExportWlicPlugin.ID, code,
            message, exception);
   }
   ...
   public static void log(IStatus status) {
	   ExportWlicPlugin.getDefault().getLog().log(status);
   }
}