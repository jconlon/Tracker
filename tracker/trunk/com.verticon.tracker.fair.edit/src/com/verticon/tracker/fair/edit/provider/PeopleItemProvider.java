...
/**
 * Non-model based People node in the Tree View
 * Created for Ticket 240 
 * See EMF Modeling book 14.2.3
 * @author jconlon
 *
 */
public class PeopleItemProvider extends TransientFairItemProvider {

	public PeopleItemProvider(AdapterFactory adapterFactory, Fair fair) {
	...
	protected Collection<? extends EReference> getChildrenReferences(
		...
		if(childrenReferences == null){
			...
			childrenReferences.add(FairPackage.eINSTANCE.getFair_People());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				FairEditPlugin.INSTANCE.getImage("full/obj16/Person"));
	}
    ...
    {
      if (new AddCommand(domain, (EObject)owner, FairPackage.eINSTANCE.getFair_People(), collection).canExecute())
