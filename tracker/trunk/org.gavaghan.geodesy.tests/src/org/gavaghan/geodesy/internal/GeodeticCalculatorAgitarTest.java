...
public class GeodeticCalculatorAgitarTest extends TestCase  {
    
    public Class<GeodeticCalculator> getTargetClass()  {
        return GeodeticCalculator.class;
    }
    
//    public void testConstructor() throws Throwable {
//        GeodeticCalculator geodeticCalculator = new GeodeticCalculator();
//        assertEquals("geodeticCalculator.TwoPi", 
//        		6.283185307179586, ((Number) getPrivateField(geodeticCalculator, "TwoPi")).doubleValue(), 1.0E-6);
//    }
...
//    }
    ...
    public void testCalculateGeodeticCurve3() throws Throwable {
        GlobalCoordinates globalCoordinates = new GlobalCoordinates(
        		1.2332849502563477, 100.0);
        GeodeticCurve result = new GeodeticCalculator().calculateGeodeticCurve(
        		EllipsoidTestHelper.createGRS80(), 
        		new GlobalCoordinates(1.2948811054229736, 100.0), 
        		globalCoordinates);
        assertEquals("result.getAzimuth()", 
        		180.0, 
        		result.getAzimuth(), 
        		1.0E-6);
    }
