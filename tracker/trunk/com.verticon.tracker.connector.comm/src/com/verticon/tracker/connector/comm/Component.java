 ...
 */
public class Component implements ConnectionFactory {

	private static final String PLUGIN_ID = "com.verticon.tracker.connector.comm";
	...
	static {
		Component.bundleMarker.add(MarkerFactory
				.getMarker("IS_BUNDLE"));
	}
