...
# Tracker Premises Reports infrastructure, @com.verticon.tracker.premises.reports@ that has been deployed to a shared BIRT resource library;

h2. Installation

# Download the Tracker Premises Reports infrastructure @com.verticon.tracker.premises.reports@ and import it into your workspace
# Open the Reports.html file and follow installation directions
...
Reports can also be launched from a browser with a parameterized URL that specifies running BIRT Web Server, the report file path and which premises document to use as a datasource. [2]
...
fn3. These are only examples as the URL to the report is system specific.
