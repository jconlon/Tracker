...
/**
 * This is the item provider adapter for a {@link org.usaha.ecvi.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcviPackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcviPackage.Literals.PERSON__PHONE,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcviPackage.Literals.PERSON__PHONE);
		}
	 ...
	 * Just show the name <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	@Override
 ...
 label;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Person.class)) {
			case EcviPackage.PERSON__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case EcviPackage.PERSON__PHONE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcviPackage.Literals.PERSON__PHONE,
				 EcviFactory.eINSTANCE.createPhoneNum()));
	}
