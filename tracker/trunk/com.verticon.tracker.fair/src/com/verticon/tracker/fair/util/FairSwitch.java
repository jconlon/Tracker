...
public class FairSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FairPackage.YOUTH_CLUB: {
				YouthClub youthClub = (YouthClub)theEObject;
				T result = caseYouthClub(youthClub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FairPackage.DIVISION: {
				Division division = (Division)theEObject;
				T result = caseDivision(division);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FairPackage.DEPARTMENT: {
				Department department = (Department)theEObject;
				T result = caseDepartment(department);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FairPackage.CLASS: {
				com.verticon.tracker.fair.Class class_ = (com.verticon.tracker.fair.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FairPackage.LOT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Youth Club</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Youth Club</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseYouthClub(YouthClub object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(com.verticon.tracker.fair.Class object) {
		return null;
	}
