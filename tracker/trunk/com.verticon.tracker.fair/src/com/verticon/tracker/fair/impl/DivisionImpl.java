...
public class DivisionImpl extends EObjectImpl implements Division {
	...
	protected EClass eStaticClass() {
		return FairPackage.Literals.DIVISION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FairPackage.DIVISION__NAME, oldName, name));
	}
	...
	public void setComments(String newComments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FairPackage.DIVISION__COMMENTS, oldComments, comments));
	}
