...
org.usaha.ecvi.store.mqtt Version 1.0.0
...
Ecvi Store Mqtt is a _EcviStore_ implementation that uses the Message Queue Telemetry Transport (_MQTT_) Protocol to access Tracker Cloud based EcviStore document repositories. The iRouter Bridge is a Message translator and bridge passing Ecvi documents between the MQTT and the Tracker iRouter framework.

Visit "Tracker iRouter":http://verticon.com/products/iRouter.html for more details about the iRouter.
