...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Number Occurrence</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.verticon.oasis.xal.XalPackage#getNumberOccurrence()
 * @model extendedMetaData="name='NumberOccurrence_._type'"
 * @generated
 */
public enum NumberOccurrence implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Number Occurrence</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NumberOccurrence[] VALUES_ARRAY =
	...
	/**
	 * A public read-only list of all the '<em><b>Number Occurrence</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NumberOccurrence> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Number Occurrence</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberOccurrence get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberOccurrence result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Occurrence</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberOccurrence getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberOccurrence result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Occurrence</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberOccurrence get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private NumberOccurrence(int value, String name, String literal) {
		this.value = value;
		this.name = name;
