...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Number Range Occurrence</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.verticon.oasis.xal.XalPackage#getNumberRangeOccurrence()
 * @model extendedMetaData="name='NumberRangeOccurrence_._type'"
 * @generated
 */
public enum NumberRangeOccurrence implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Number Range Occurrence</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NumberRangeOccurrence[] VALUES_ARRAY =
		new NumberRangeOccurrence[] {
			BEFORE_NAME,
			AFTER_NAME,
			BEFORE_TYPE,
			AFTER_TYPE,
	...
	/**
	 * A public read-only list of all the '<em><b>Number Range Occurrence</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NumberRangeOccurrence> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Number Range Occurrence</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberRangeOccurrence get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberRangeOccurrence result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Range Occurrence</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberRangeOccurrence getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberRangeOccurrence result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Range Occurrence</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberRangeOccurrence get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private NumberRangeOccurrence(int value, String name, String literal) {
		this.value = value;
		this.name = name;
