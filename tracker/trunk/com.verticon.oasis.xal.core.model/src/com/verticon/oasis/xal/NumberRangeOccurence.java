...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Number Range Occurence</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.verticon.oasis.xal.XalPackage#getNumberRangeOccurence()
 * @model extendedMetaData="name='NumberRangeOccurence_._type'"
 * @generated
 */
public enum NumberRangeOccurence implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Number Range Occurence</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NumberRangeOccurence[] VALUES_ARRAY =
		new NumberRangeOccurence[] {
			BEFORE_NAME,
			AFTER_NAME,
			BEFORE_TYPE,
			AFTER_TYPE,
	...
	/**
	 * A public read-only list of all the '<em><b>Number Range Occurence</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NumberRangeOccurence> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Number Range Occurence</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberRangeOccurence get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberRangeOccurence result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Range Occurence</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberRangeOccurence getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NumberRangeOccurence result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Number Range Occurence</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static NumberRangeOccurence get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private NumberRangeOccurence(int value, String name, String literal) {
		this.value = value;
		this.name = name;
