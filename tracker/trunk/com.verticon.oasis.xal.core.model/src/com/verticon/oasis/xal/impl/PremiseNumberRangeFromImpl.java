...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Premise Number Range From</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.verticon.oasis.xal.impl.PremiseNumberRangeFromImpl#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.impl.PremiseNumberRangeFromImpl#getPremiseNumberPrefix <em>Premise Number Prefix</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.impl.PremiseNumberRangeFromImpl#getPremiseNumber <em>Premise Number</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.impl.PremiseNumberRangeFromImpl#getPremiseNumberSuffix <em>Premise Number Suffix</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PremiseNumberRangeFromImpl extends MinimalEObjectImpl.Container implements PremiseNumberRangeFrom {
	/**
	 ...
	 * @generated
	 */
	protected PremiseNumberRangeFromImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return XalPackage.eINSTANCE.getPremiseNumberRangeFrom();
	}
	...
	public EList<AddressLine> getAddressLine() {
		if (addressLine == null) {
			addressLine = new EObjectContainmentEList<AddressLine>(AddressLine.class, this, XalPackage.PREMISE_NUMBER_RANGE_FROM__ADDRESS_LINE);
		}
		return addressLine;
	}
	...
	public EList<PremiseNumberPrefix> getPremiseNumberPrefix() {
		if (premiseNumberPrefix == null) {
			premiseNumberPrefix = new EObjectContainmentEList<PremiseNumberPrefix>(PremiseNumberPrefix.class, this, XalPackage.PREMISE_NUMBER_RANGE_FROM__PREMISE_NUMBER_PREFIX);
		}
	...
	public EList<PremiseNumber> getPremiseNumber() {
		if (premiseNumber == null) {
			premiseNumber = new EObjectContainmentEList<PremiseNumber>(PremiseNumber.class, this, XalPackage.PREMISE_NUMBER_RANGE_FROM__PREMISE_NUMBER);
		}
	...
	public EList<PremiseNumberSuffix> getPremiseNumberSuffix() {
		if (premiseNumberSuffix == null) {
			premiseNumberSuffix = new EObjectContainmentEList<PremiseNumberSuffix>(PremiseNumberSuffix.class, this, XalPackage.PREMISE_NUMBER_RANGE_FROM__PREMISE_NUMBER_SUFFIX);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XalPackage.PREMISE_NUMBER_RANGE_FROM__ADDRESS_LINE:
				return ((InternalEList<?>)getAddressLine()).basicRemove(otherEnd, msgs);
			case XalPackage.PREMISE_NUMBER_RANGE_FROM__PREMISE_NUMBER_PREFIX:
				return ((InternalEList<?>)getPremiseNumberPrefix()).basicRemove(otherEnd, msgs);
			case XalPackage.PREMISE_NUMBER_RANGE_FROM__PREMISE_NUMBER:
				return ((InternalEList<?>)getPremiseNumber()).basicRemove(otherEnd, msgs);
			case XalPackage.PREMISE_NUMBER_RANGE_FROM__PREMISE_NUMBER_SUFFIX:
