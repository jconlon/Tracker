...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Thoroughfare Number From</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getAddressLine <em>Address Line</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getThoroughfareNumberPrefix <em>Thoroughfare Number Prefix</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getThoroughfareNumber <em>Thoroughfare Number</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getThoroughfareNumberSuffix <em>Thoroughfare Number Suffix</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getCode <em>Code</em>}</li>
 *   <li>{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom()
 * @model extendedMetaData="name='ThoroughfareNumberFrom_._type' kind='mixed'"
 * @generated
 */
public interface ThoroughfareNumberFrom extends EObject {
	/**
	 ...
	 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom_Mixed()
	 ...
	 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom_AddressLine()
	 ...
	 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom_ThoroughfareNumberPrefix()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom_ThoroughfareNumber()
	 ...
	 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom_ThoroughfareNumberSuffix()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see #setCode(Object)
	 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom_Code()
	...
	/**
	 * Sets the value of the '{@link com.verticon.oasis.xal.ThoroughfareNumberFrom#getCode <em>Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.verticon.oasis.xal.XalPackage#getThoroughfareNumberFrom_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
