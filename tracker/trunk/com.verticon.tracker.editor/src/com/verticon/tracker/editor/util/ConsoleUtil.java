...
public class ConsoleUtil {
	...
	/**
	 * returns the default (cached) MessageConsoleStream for the specified
	 * console name
	 * 
	 * @param name -
	 ...
	 */
	private synchronized static MessageConsoleStream getDefaultStream(
			String name) {
	...
	/**
	 * Convenient static method to print an string on the specified console. The
	 * color of the message printed is by black.
	 * 
	 * The client of this method does not need to do any housekeeping work to
	 * use this method. All pre-work for example registering the console with
	 * the Eclipse console manager if neccessary, creating the message stream,
	 * setting the color are handled by the method if neccesary.
	 * 
	 * @param name -
