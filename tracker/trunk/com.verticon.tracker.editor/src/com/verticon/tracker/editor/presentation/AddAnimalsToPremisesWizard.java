 ...
 * 
 */
public class AddAnimalsToPremisesWizard extends Wizard {
	...
	public boolean performFinish() {
		...
		ActionUtils.addTemplate(premises, tagsBean, getTemplateBean(), editor);
	...
	private TemplateAnimalBean getTemplateBean(){
		Animal animal = selectAnimalWizardPage.getAnimal();
		Event event = selectEventWizardPage.getEvent();
