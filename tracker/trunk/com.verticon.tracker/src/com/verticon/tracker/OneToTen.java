...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>One To Ten</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.verticon.tracker.TrackerPackage#getOneToTen()
 * @model
 * @generated
 */
public enum OneToTen implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>One To Ten</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final OneToTen[] VALUES_ARRAY =
		new OneToTen[] {
			UNSPECIFIED,
			ONE,
			TWO,
	...
	/**
	 * A public read-only list of all the '<em><b>One To Ten</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<OneToTen> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>One To Ten</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static OneToTen get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			OneToTen result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>One To Ten</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static OneToTen getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			OneToTen result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>One To Ten</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static OneToTen get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private OneToTen(int value, String name, String literal) {
		this.value = value;
		this.name = name;
