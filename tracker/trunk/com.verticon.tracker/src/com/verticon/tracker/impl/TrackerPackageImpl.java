...
public class TrackerPackageImpl extends EPackageImpl implements TrackerPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getTag_Events(), this.getEvent(), this.getEvent_Tag(), "events", null, 0, -1, Tag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
