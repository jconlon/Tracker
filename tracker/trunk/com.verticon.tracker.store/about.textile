h1=. Tracker Store Utilities and Location Service Provider

com.verticon.tracker.store Version 0.1.0
...
Tracker Store Utilities and Location Service Provider is a set of data access models and utilities that support implementations of the Tracker Store specification for document storage services and a provider of a Location Service that works on top of all Tracker Store implementations to resolve universal identifiers and geographic coordinates to location names. 
