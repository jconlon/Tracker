...
public class IsAuthenticatedUserPropertyTester extends PropertyTester {

	public static final String PROPERTY_IS_NOT_SIGNED_ON = "isNotSignedOn";
	public static final String PROPERTY_IS_SIGNED_ON = "isSignedOn";
	public static final String PROPERTY_HAS_USERADMIN_SERVICE = "hasUserAdminService";

	/**
	 * 
	 * Tests if there is a ITrackerLoader service available.
	 * 
	...
	public boolean test(Object receiver, String property, Object[] args,
		...
		if (PROPERTY_IS_SIGNED_ON.equals(property)) {
			return Activator.getDefault().isAuthenticatedUser();
		}
		if (PROPERTY_IS_NOT_SIGNED_ON.equals(property)) {
			return !Activator.getDefault().isAuthenticatedUser();
		}
