 ...
 * <ul>
 *   <li>{@link com.verticon.google.kmlgx.impl.WaitImpl#getDuration <em>Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WaitImpl extends TourPrimitiveImpl implements Wait {
	/**
	...
	protected EClass eStaticClass() {
		return KmlgxPackage.Literals.WAIT;
	}
	...
	public void setDuration(double newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KmlgxPackage.WAIT__DURATION, oldDuration, duration, !oldDurationESet));
	}
	...
	public void unsetDuration() {
		...
		durationESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, KmlgxPackage.WAIT__DURATION, oldDuration, DURATION_EDEFAULT, oldDurationESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KmlgxPackage.WAIT__DURATION:
				return getDuration();
		}
