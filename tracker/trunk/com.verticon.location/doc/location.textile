...
__This document is the first draft of an Tracker Location User Guide and is only intended as an overview to the technologies used for the Tracker Location Services. Future versions will fully serve the intended function of a comprehensive user guide for the installation and configuration of the Tracker Location Services.__


h2. Agriculture Location Services

Tracker Location Service integrates state of the art GIS(Geographic Information System) technologies with livestock premises based animal histories and premises to premises animal movements to offer livestock professionals a comprehensive and open desktop solution[1] for the managing and visualizing of geographic livestock distributions, animal locations, and animal movements within and between premises locations. 
