...
final class KeyCodec {
	...
	/**
	 * Encodes a given key by replacing all '.' and '$' with their URL encoded
	 * variants.
	 * 
	 * @param input
	...
	/**
	 * Decodes a given key by replacing all URL encoded '.' and '$' entities
	 * with their real characters.
	 * 
	 * @param input
	 *            the input to decode, may be <code>null</code>.
