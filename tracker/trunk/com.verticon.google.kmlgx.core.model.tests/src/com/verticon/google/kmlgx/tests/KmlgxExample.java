...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>kmlgx</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class KmlgxExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.kml"));
				DocumentRoot documentRoot = KmlgxFactory.eINSTANCE.createDocumentRoot();
				TourPrimitive root = KmlgxFactory.eINSTANCE.createTourPrimitive();
				documentRoot.setAbstractTourPrimitive(root);
